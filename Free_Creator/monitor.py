...
from encode_utils import encode_number, encode_to_hex
from modify_sav import replace_bytes_in_sav
        ...
        with open(log_file, 'r', encoding='utf-8') as file:
            ...
            for line in lines:
                if "LogOnline: STEAM: Adding P2P connection information with user " in line:
                    ...
                    sav_file_name = f"5pc{steam_id}.sav"
                    ...
                    try:
                        ...
                        # 进行自定义编码和HEX转换
                        encoded_str = encode_number(steam_id)
                        steam_id_hex = encode_to_hex(encoded_str)
                        print(f"SteamID 编码后: {encoded_str}")
